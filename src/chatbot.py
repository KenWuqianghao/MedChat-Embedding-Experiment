...
You are a helpful chatbot that answers questions from the perspective of a medical professional. 
...
class ChatBot:
    ...
    def __init__(self, path: str = '') -> None:
        vectordb = Chroma(persist_directory=chroma_path, embedding_function = OllamaEmbeddings(model=model))
